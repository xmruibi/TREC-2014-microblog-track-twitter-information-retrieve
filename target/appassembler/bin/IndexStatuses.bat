...
%JAVACMD% %JAVA_OPTS% -Xmx16g -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="IndexStatuses" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" cc.twittertools.index.IndexStatuses %CMD_LINE_ARGS%
