...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="RunQueriesThrift" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" cc.twittertools.search.api.RunQueriesThrift %CMD_LINE_ARGS%
