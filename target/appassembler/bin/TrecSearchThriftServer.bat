...
%JAVACMD% %JAVA_OPTS% -Xmx16g -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="TrecSearchThriftServer" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" cc.twittertools.search.api.TrecSearchThriftServer %CMD_LINE_ARGS%
