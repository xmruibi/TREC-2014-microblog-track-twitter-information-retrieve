...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="ExtractTweetidsFromCollection" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" cc.twittertools.index.ExtractTweetidsFromCollection %CMD_LINE_ARGS%
