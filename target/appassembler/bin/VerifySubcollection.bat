...
%JAVACMD% %JAVA_OPTS% -Xmx4g -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="VerifySubcollection" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" cc.twittertools.util.VerifySubcollection %CMD_LINE_ARGS%
