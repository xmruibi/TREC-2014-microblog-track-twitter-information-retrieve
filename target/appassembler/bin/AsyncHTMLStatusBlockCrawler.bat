...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="AsyncHTMLStatusBlockCrawler" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" cc.twittertools.download.AsyncHTMLStatusBlockCrawler %CMD_LINE_ARGS%
